...
export const DisclaimerSetting = ({ titleKey = "settings.disclaimer.title", messageKey = "settings.disclaimer.message", shortMessageKey = "settings.disclaimer.shortMessage", iconName = "AlertTriangle", iconColor, backgroundColor, modalTitle, modalContent, }) => {
    ...
    return (<>
      <TouchableOpacity style={[
        ...
        ]} onPress={() => setModalVisible(true)} activeOpacity={0.7} testID="disclaimer-setting">
        {/* Icon and Title Row */}
        <View style={styles.headerRow}>
          <View style={[
            ...
            <AtomicIcon name={iconName} color={iconColor || "warning"}/>
          </View>
      ...
      <Modal visible={modalVisible} animationType="slide" presentationStyle="pageSheet" onRequestClose={() => setModalVisible(false)}>
        <View style={[
          ...
          <View style={[
            ...
            <TouchableOpacity onPress={() => setModalVisible(false)} testID="close-disclaimer-modal">
